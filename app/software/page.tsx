...
export const metadata: Metadata = createPageMetadata({
  path: "/software",
  title: "Software, CRM, Websites & Automation Portfolio | Ultimate Moxie",
  description: "Explore Next.js websites, landing pages, web applications, CRM systems, business automation workflows and SaaS product development by Ultimate Moxie.",
});
...
export default function SoftwarePage() {
  ...
  return <>
    <PageHero index="02" eyebrow="SOFTWARE + PRODUCTS" title={<>I turn ideas<br />into <em>working products.</em></>} copy="Web development across Next.js applications, landing pages, CRM systems, SaaS products and business automation workflows designed around real problems." />
